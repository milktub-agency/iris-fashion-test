...
class MenuDrawerCollection extends HTMLElement {
  constructor() {
    super();
...
customElements.define("menu-drawer-collection", MenuDrawerCollection);
...
class SliderComponent extends HTMLElement {
  constructor() {
    ...
    if (!this.slider || !this.nextButton || !this.paginationContainer) return;
  ...
  createPagination() {
    ...
    for (let i = 0; i < this.totalPages; i++) {
      ...
      dot.dataset.index = i;
      dot.addEventListener("click", this.onPaginationDotClick.bind(this));
      this.paginationContainer.appendChild(dot);
    }
    this.updatePagination();
  }

  onPaginationDotClick(event) {
...
//   let sizeInputElments = document.querySelectorAll(".variant-button--swatch");
//   sizeInputElments.forEach((each) => {
