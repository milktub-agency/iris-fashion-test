class SliderComponentNew extends HTMLElement {
  constructor() {
    super();
...
customElements.define("slider-component-new", SliderComponentNew);

class SlideshowComponentNew extends SliderComponentNew {
  constructor() {
    super();
...
customElements.define("slideshow-component-new", SlideshowComponentNew);
